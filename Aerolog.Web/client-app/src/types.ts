...
export type LogByIdQuery = { __typename?: 'Query', log?: Array<{ __typename?: 'Log', id: string, speakerName: string, text: string, timestamp: any } | null | undefined> | null | undefined };
